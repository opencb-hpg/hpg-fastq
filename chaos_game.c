...
//-----------------------------------------------------------
// chaos_game_load_table_gs (directly over table_gs)
//-----------------------------------------------------------
...
//-----------------------------------------------------------
// chaos_game_calculate_table_dif
//-----------------------------------------------------------
...
//-----------------------------------------------------------
// chaos_game_validate_table_dif
// input: normalized table_dif with positive and 
//        negative values
//-----------------------------------------------------------
...
//-----------------------------------------------------------
// chaos_game_normalize_quality_table_
//-----------------------------------------------------------
...
//-----------------------------------------------------------
// chaos_game_absolute_diff_table_
//-----------------------------------------------------------
...
void chaos_game_generate_pgm_file_(unsigned int** table, int dim_n, double norm, int k_cg, char* pgm_filename) {  
  ...
  for (i=0; i< redim_n; i++) {			//redim_n >= dim_n with every condition
