...
//------------------------------------------------------------------------------------
//  kernel QC implementation with registers
//------------------------------------------------------------------------------------

//---------------------------------------------------------------------------------------------
//  GPU kernel for preprocessing/filtering rtrim_nts == rfilter_nts and ltrim_nts == lfilter_nts
//  both sides quality is calculated only once (GPU implementation)
//---------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------
//  GPU kernel for preprocessing/filtering rtrim_nts != rfilter_nts and ltrim_nts != lfilter_nts
//  trim and filter quality is calculated separately  (GPU implementation)
//---------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------
//  GPU kernel for QC step only, overhead introduced by preprocessing/filtering 
//  is not included in this GPU implementation
//---------------------------------------------------------------------------------------------
