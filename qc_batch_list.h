...
#ifndef QC_BATCH_LIST_H
#define QC_BATCH_LIST_H
...
// #define READ_QUALITY 5			//Mean quality of the read
// #define LAST_NTS_QUALITY 8		//Mean quality of the last n nucleotides
// #define MEDIAN_QUALITY 9			//Median of the quality of each read nucleotide
// #define OUT_OF_RANGE_QUALITY 0	//Number of nucleotides out of quality set range (min, max)
// #define LCUT_QUALITY 	1		//Mean quality of left-cut read
// #define RCUT_QUALITY	3			//Mean quality of right-cut read
// #define CUT_QUALITY	4			//Mean quality of left and right cut read
// #define FIRST_NTS_QUALITY 7 		//Mean quality of the first n nucleotides
...
// #define GET_8_16(x)		((x & 65280) >> 8)
// #define GET_16_24(x)		((x & 16711680) >> 16)
// #define GET_24_32(x)		((x & 4278190080) >> 24)
// #define GET_0_12(x)		(x & 4095)
// #define GET_12_22(x)		((x & 4190208) >> 12)
...
/**
* @brief List of qc_batch structures
* 
* List to contain and link qc batches
*/
typedef struct qc_batch_list {
	int length;			/**< Total length of the list */
	pthread_mutex_t lock;		/**< Lock  */
	struct qc_batch* first_p;	/**< Pointer to the first batch in the list */
	struct qc_batch* last_p;	/**< Pointer to the last batch in the list */
} qc_batch_list_t;

/**
*  @brief Init a qc batch list
*  @param[in,out] qc_batch_list_p pointer to the list to initialize
*  @return void
*  
*  Performs qc batch list initialization
*/
void qc_batch_list_init(qc_batch_list_t* qc_batch_list_p);

/**
*  @brief Inserts qc batch in a list
*  @param qc_batch_p pointer to the qc batch to insert in the list
*  @param[in,out] qc_batch_list_p pointer to the list in where batch will be inserted
*  @return void
*  
*  Inserts a qc batch in a qc batch list
*/
void qc_batch_list_insert(qc_batch_t* qc_batch_p, qc_batch_list_t* qc_batch_list_p);

/**
*  @brief Removes qc batch from a list
*  @param[in,out] qc_batch_list_p pointer to the list from where batch will be removed
*  @return qc_batch_t pointer to the removed batch
*  
...
/**
*  @brief Prints a qc batch list in the console
*  @param qc_batch_list_p pointer to the qc batch list
*  @return void
*  
*  Prints the content of each qc batch from the list in the console
*/
void qc_batch_list_print(qc_batch_list_t* qc_batch_list_p);

/**
*  @brief Frees qc batch list items
*  @param[in,out] qc_batch_list_p pointer to the qc batch list
*  @return void
*  
*  Free qc batch list items
*/
